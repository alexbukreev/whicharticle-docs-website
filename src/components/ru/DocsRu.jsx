                    ...
                    <h4>Словарь</h4>
                        <div className="row">
                          ...
                          <div className="col s12 m8 l8">
                              ...
                              <p>
                                В словаре представлены все существительные, доступные в приложении. Сверху слева показано текущее число таких существительных («Total nouns»). 
                              </p>
                              <p>
                              ...
                              <ol>
                                <li>
                                  Добавляемое слово уже существует в словаре приложения. В этом случае приложение выведет сообщение «The word <i>”слово”</i> already exists in this dictionary», и в интерфейсе словаря произойдет автоматический переход к этому слову.
                                </li>
                                <br/>
                                <li>
                                  Добавляемое слово не существует в словаре приложения, но имеется на сервере в общем словаре. Если это слово имеет формы существительного, то оно добавляется в словарь приложения. В этом случае приложение выведет сообщение «The word <i>”слово”</i> has been added to this dictionary», и в интерфейсе словаря произойдет автоматический переход к этому слову.
                                </li>
                                <br/>
                                <li>
                                  Добавляемое слово не существует в словаре приложения и не содержится в общем словаре на сервере. В этом случае приложение выведет сообщение «The word <i>”слово”</i> is missing from the main dictionary on the server and cannot be added».
                                </li>
                                <br/>
                                <li>
                                  Добавляемое слово не существует в словаре приложения и является инфинитивом (отглагольным существительным). В ряде случаев такое слово не будет добавляться в словарь приложения, и выводится сообщение «The word <i>”слово”</i> is an infinitive (verb) used as a noun. Words like this (Fahren, Trinken, etc.) always have «Das» as their article».
                                </li>
                              </ol>
                          </div>
                        </div>
